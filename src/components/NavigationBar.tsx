...
const NavigationBar: React.FC<NavigationBarProps> = ({ }) => {
  ...
  return (
    <div className='container d-flex justify-content-center mt-4 mb-3 mb-md-5'>

      <Link className="ms-auto nav-link p-0 ps-2 pe-2 d-flex justify-content-center align-items-center rounded-pill bg-black shadow" to="/">
        <span className={`wb-text-gray rounded-pill p-1 pe-2 ps-2 ${(active === '') ? 'active' : ''}`}>
